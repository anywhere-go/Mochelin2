    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //보낼 파일
                RequestBody fileBody = RequestBody.create(photoFile, MediaType.parse("image/jpg"));  //jpg 파일로 보내겠다.
                MultipartBody.Part photo = MultipartBody.Part.createFormData("photo", photoFile.getName(), fileBody);  //잘게 쪼개서 넘긴다.
                //보낼 텍스트
                RequestBody textBody = RequestBody.create(content, MediaType.parse("text/plain"));
                Call< ResultRes> call  = api.addPosting("Bearer " + token, photo, textBody);
        ...
        if(permissionCheck != PackageManager.PERMISSION_GRANTED){
            ...
            if(i.resolveActivity(AddActivity.this.getPackageManager())  != null  ){
                ...
                Uri fileProvider = FileProvider.getUriForFile(AddActivity.this,
                        "com.jwlee.postingapp.fileprovider", photoFile);
                i.putExtra(MediaStore.EXTRA_OUTPUT, fileProvider);
                startActivityForResult(i, 100);

            } else{
                Toast.makeText(AddActivity.this, "이 폰에는 카메라 앱이 없습니다.",
                        Toast.LENGTH_SHORT).show();
            }
        }
